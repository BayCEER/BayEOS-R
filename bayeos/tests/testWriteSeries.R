...
test.WriteSeries<-function(){				
	...
	datetime = c(as.POSIXct('2011-01-01 11:00',tz='Etc/GMT-1'),as.POSIXct('2011-01-01 12:00',tz='Etc/GMT-1'),as.POSIXct('2011-01-01 13:00',tz='Etc/GMT-1'),as.POSIXct('2011-01-01 14:00',tz='Etc/GMT-1'))		
